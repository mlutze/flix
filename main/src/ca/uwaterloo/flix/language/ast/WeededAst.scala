...
object WeededAst {
  ...
  object Declaration {
    ...
    case class Class(doc: Ast.Doc, ann: List[WeededAst.Annotation], mod: Ast.Modifiers, ident: Name.Ident, tparams: WeededAst.TypeParams, superClasses: List[WeededAst.TypeConstraint], sigs: List[WeededAst.Declaration.Sig], laws: List[WeededAst.Declaration.Def], loc: SourceLocation) extends WeededAst.Declaration

    case class Instance(doc: Ast.Doc, ann: List[WeededAst.Annotation], mod: Ast.Modifiers, clazz: Name.QName, tpes: List[WeededAst.Type], tconstrs: List[WeededAst.TypeConstraint], defs: List[WeededAst.Declaration.Def], loc: SourceLocation) extends WeededAst.Declaration
  ...
  case class TypeConstraint(clazz: Name.QName, tpes: List[WeededAst.Type], loc: SourceLocation)
