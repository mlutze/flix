...
object ResolvedAst {
  ...
  case class Instance(doc: Ast.Doc, ann: List[ResolvedAst.Annotation], mod: Ast.Modifiers, sym: Symbol.InstanceSym, tpes: List[Type], tconstrs: List[ResolvedAst.TypeConstraint], defs: List[ResolvedAst.Def], ns: Name.NName, loc: SourceLocation)
  ...
  case class TypeConstraint(head: Ast.TypeConstraint.Head, tpes: List[Type], loc: SourceLocation)
}
